...
const Conditions = (props) => {
    if (Object.keys(props.responseObj).length !== 0) {
        const rain = props.responseObj.hourly.rain[0] * 10
        ...
        return (
            <div>
                ...
                <div>
                    ...
                    {rain > 5 ? <span class="material-symbols-outlined">partly_cloudy_day</span> : <span class="material-symbols-outlined">partly_cloudy_day</span> }
